...
const CategoryCard = ({ name, image, onClick }) => {
  return (
    <div
      className="w-[120px] h-[120px] md:w-[180px] md:h-[180px] rounded-2xl border-2 border-[#ff4d2d] shrink-0 overflow-hidden bg-white shadow-2xl shadow-gray-200 hover:shadow-lg transition-shadow relative"
      onClick={onClick}
    >
      <img
        src={image}
